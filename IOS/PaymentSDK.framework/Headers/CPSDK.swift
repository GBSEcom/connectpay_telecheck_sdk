...
@objc public class CPSdkConfiguration: NSObject {
    ...
    fileprivate var _environment = Environment.qa
    var baseUrl: String {
        switch _environment {
        case .qa: return "https://qa.api.firstdata.com/connectpayapi/v1"
        case .cat: return "https://cat.api.firstdata.com/connectpayapi/v1"
        case .prod: return "https://api.firstdata.com/connectpayapi/v1"
        }
    }
}
