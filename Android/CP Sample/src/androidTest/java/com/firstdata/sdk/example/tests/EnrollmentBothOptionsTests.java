...
import static com.firstdata.sdk.example.TestUtils.CP_ENROLLMENT_BOTH_OPTIONS;
...
public class EnrollmentBothOptionsTests {
    ...
    public void TermsOneAtATimeSuccess() throws InterruptedException {
        pickFlow(CP_ENROLLMENT_BOTH_OPTIONS);
        pickManual();
